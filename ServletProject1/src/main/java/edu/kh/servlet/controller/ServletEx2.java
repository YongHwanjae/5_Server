...
// Servlet 코드를 작성하기 위해서는 HttpServlet을 상속 받아야한다.
public class ServletEx2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// radio 버튼은 1개만 선택만 가능== 값 1개만 서버로 제출됨
		String type = req.getParameter("type");
		
		// select박스는 1개의 option만 선택 가능 == 값 1개만 서버로 제출됨.
...
//		String opt= req.getParameter("opt");
		...
		if(opt !=null) {
			...
			for(String o : opt) {
				...
				switch(o) {
				case "shot1" : temp = "1샷 추가";
				case "shot2" : temp = "2샷 추가";
				case "softly" : temp = "연하게";
